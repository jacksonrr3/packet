...
BOOST_AUTO_TEST_CASE(packet_test_tcp)
{
	...
	BOOST_REQUIRE_EQUAL(l3_tcp->destination()->to_string() , "13.33.242.204");
	BOOST_REQUIRE_EQUAL(l3_tcp->source()->to_string(), "192.168.10.2");

	BOOST_REQUIRE_EQUAL(l4_tcp->name(), "Transmission_Control_Protocol");
	BOOST_REQUIRE_EQUAL(l4_tcp->destination()->to_string(), "443");
	BOOST_REQUIRE_EQUAL(l4_tcp->source()->to_string() , "61316");
